...
extern int startyear, startmonth, startday;//used for saving the last date checked before closing the program
...
extern char * theworkingdirectory;
...
void buttonMCreationRoutine(HWND* buttonarray, HWND hwnd, LPWSTR* Months);
...
extern COLORREF ColorSelection[100];

extern int shoddyvar;

extern HBITMAP * MyBitmapsArray[100];
...
extern RGBData colorsdata[170];
extern HWND FontBoxHwnd;
extern RECT FontBoxRect;
extern BOOL CreationFlag;
